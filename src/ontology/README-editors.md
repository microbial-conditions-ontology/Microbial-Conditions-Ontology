These notes are for the EDITORS of mco
...
There are two ways to include new classes in an import module
 ...
 2. Add to the imports/mco_terms.txt file
...
Note: the mco_terms.txt file may include 'starter' classes seeded from
...
what is in the `owl:versionIRI` of the derived mco.owl (`data-version` in
mco.obo). This will be today's date.
...
Note: if you have only just created this project you will need to authorize travis for this repo.
 ...
 1. Go to [https://travis-ci.org/profile/microbial-conditions-ontology](https://travis-ci.org/profile/microbial-conditions-ontology)
 2. click the "Sync account" button
 3. Click the tick symbol next to Microbial-Conditions-Ontology
